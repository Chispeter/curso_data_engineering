...
stg_sql_server_dbo__orders AS (
    SELECT
        ...
        cast(base_orders.user_id as varchar(50)) AS order_customer_id,
        cast(base_orders.address_id as varchar(50)) AS order_address_id,
        cast(base_promos.promo_id as varchar(50)) AS order_promotion_id,
        cast(base_orders.tracking_id as varchar(50)) AS order_tracking_id,
        cast(base_orders.shipping_service as varchar(20)) AS order_shipping_service_name,
        cast(base_orders.shipping_cost as number(38,2)) AS order_shipping_service_cost_in_usd,
